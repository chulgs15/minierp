...
public enum LedgerErrors {
  ...
  LEDGER_00004("You cannot reverse unless the status is POST.",
      "You have to delete it when it's NEW."),
  LEDGER_00005("You cannot reverse twice.", "Create new Journal"),
  LEDGER_00006("The amount does not match the debit and credit.",
      "Please match the debit and credit total."),
  ...
  LEDGER_00009("This journal already posted", "you cannot post it."),
  ;
